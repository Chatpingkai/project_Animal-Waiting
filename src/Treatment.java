...
public class Treatment {
    ...
    panelnameA, paneltype, paneladdress, panelpayee, panelsignature;
    private JMenuBar menuBar;
    private JMenu treatment, trCosts;
    private JLabel pureAmount, description, amount, sumPureAmountTH, nameO, nameA, type, 
    address, payee, signature, receipt;
    private JTextArea descriptionData, amountData, sumPureAmount, thenameO, theNameA, theType, theAddrass, thePayee;
    ...
    public Treatment(){
        ...
        // treatment.setBackground(Color.RED);
        // trCosts.setOpaque(true);
        // trCosts.setBackground(Color.GREEN);
