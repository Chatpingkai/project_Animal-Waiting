...
circle_pet_female, circle_idk;
    ...
    public Register() {
        ...
        circle_male = new JRadioButton("Male");
        circle_female = new JRadioButton("female");
        circle_other = new JRadioButton("other");
        circle_male_pet = new JRadioButton("Male");
        circle_pet_female = new JRadioButton("Female");
        circle_idk = new JRadioButton("unaware");
        ...
        txt_owner.setFont(new Font("Jost", Font.BOLD, 15));
        txt_pet_information.setFont(new Font("Jost", Font.BOLD, 15));
        txt_Contact_information.setFont(new Font("Jost", Font.BOLD, 15));
        txt_regis.setFont(new Font("Jost", Font.BOLD, 15));
        ...
        empty4.setPreferredSize(new Dimension(700, 10));
        empty5.setPreferredSize(new Dimension(150, 10));
        empty6.setPreferredSize(new Dimension(80, 10));
        empty7.setPreferredSize(new Dimension(300, 10));
        empty8.setPreferredSize(new Dimension(280, 10));
        empty9.setPreferredSize(new Dimension(150, 10));
        empty10.setPreferredSize(new Dimension(40, 10));
        empty11.setPreferredSize(new Dimension(80, 10));
        empty12.setPreferredSize(new Dimension(100, 10));
        empty13.setPreferredSize(new Dimension(155, 10));
        ...
        empty17.setPreferredSize(new Dimension(165, 10));
        empty18.setPreferredSize(new Dimension(35, 10));
        empty19.setPreferredSize(new Dimension(35, 10));
        empty20.setPreferredSize(new Dimension(50, 10));
        empty21.setPreferredSize(new Dimension(150, 10));
        empty22.setPreferredSize(new Dimension(30, 10));
        ...
        empty23.setPreferredSize(new Dimension(110, 10));
        empty24.setPreferredSize(new Dimension(750, 10));
